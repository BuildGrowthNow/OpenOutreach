...
def backfill_collection(db: Any, collection_name: str, *, checkpoint: str | None, apply: bool) -> dict[str, Any]:
    ...
    last_id = checkpoint
    for document in collection.find(query).sort("_id", 1).limit(1000):
        scanned += 1
