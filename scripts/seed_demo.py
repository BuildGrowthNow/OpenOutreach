...
CONVERSATIONS = {
    10: [  # Derek
        (False, "Hey, are you the right person to talk to about outbound automation at Pulsar?", -5),
        (True, "Yes that'd be me. What's up?", -4),
        (False, "We help sales teams automate LinkedIn outreach without the risk. Curious how you're doing outbound today?", -3),
        (True, "Mostly manual. We tried a tool last year but got burned by quality issues.", -2),
        (False, "That's pretty common. What broke down - the messaging, targeting, or both?", -1),
    ],
    11: [  # Yuki
        (False, "Saw you run APAC sales at TechBridge - how do you manage outreach across so many time zones?", -7),
        (True, "It's a challenge. We have local SDRs but coordination is messy.", -6),
        (False, "Makes sense. Are you running LinkedIn outreach from a central playbook or each rep doing their own thing?", -5),
        (True, "Each rep mostly. It's hard to keep consistent.", -4),
        (False, "We built something that solves exactly that - centralizes LinkedIn outreach with per-rep personalization. Worth a 20-min call?", -3),
        (True, "Send me more details first and I'll take a look.", -2),
    ],
    12: [  # Connor
        (False, "Saw you're building Remofly - how are you finding leads for the remote-team space?", -8),
        (True, "LinkedIn mostly. Pretty manual right now.", -7),
        (False, "Same story for most early-stage founders. Are you doing the outreach yourself or do you have someone?", -6),
        (True, "Mostly me. Takes a lot of time.", -5),
        (False, "We automate the whole LinkedIn sequence - connection, follow-up, conversation handoff. Founders usually get 3-5 qualified convos/week.", -4),
        (True, "That sounds interesting actually. What does it look like in practice?", -3),
    ],
    13: [  # Fatima
        (False, "Sales enablement at Saleshift - are you the one evaluating new automation tools?", -3),
        (True, "One of a few people, yes. What are you selling?", -2),
        (False, "LinkedIn outreach automation. We focus on keeping conversations quality over volume. Happy to share a quick demo?", -1),
    ],
    14: [  # Andre
        (False, "Managing 50 reps at Optivend - how are you currently handling outbound prospecting at that scale?", -6),
        (True, "We use a mix of tools. Nothing great for LinkedIn specifically.", -5),
        (False, "LinkedIn is a gap for most teams at that size. We help centralize it - one platform, your whole team, tracked.", -4),
        (True, "Interesting. What's the typical setup time?", -3),
        (False, "Most teams are live in a day. I can walk you through it this week if you have 20 minutes.", -2),
        (True, "Sure, Thursday works. Send a calendar link.", -1),
    ],
    15: [  # Hannah (converted)
        (False, "RevOps at RevScale - curious how you're tracking LinkedIn outreach attribution today.", -12),
        (True, "Honestly we're not. It falls through the cracks.", -11),
        (False, "That's the gap we close. Every LinkedIn touch goes into a unified pipeline with conversion tracking.", -10),
        (True, "That would actually be huge for us. What does pricing look like?", -9),
        (False, "Depends on team size. Happy to walk through options - booked a slot for us: https://cal.com/demo/revscale", -8),
        (True, "Booked. See you then.", -7),
        (False, "Perfect, looking forward to it.", -6),
    ],
    16: [  # Emeka (converted)
        (False, "Healthcare enterprise sales is tough - how are you generating leads for MediTrack?", -10),
        (True, "Mostly referrals and cold email. LinkedIn is underused.", -9),
        (False, "That's the common pattern in healthcare. We've helped teams in your space add 8-12 qualified meetings per month from LinkedIn alone.", -8),
        (True, "That's a big number. How?", -7),
        (False, "Automated, personalized outreach that doesn't look automated. We handle the sequence, you handle the conversations.", -6),
        (True, "I'd like to see this in action. Do you have a demo?", -5),
        (False, "Absolutely. Here's a link to book: https://cal.com/demo/meditrack", -4),
        (True, "Done. See you Friday.", -3),
    ],
    17: [  # Sara (not interested / failed)
        (False, "Sales coaching + LinkedIn - do you use automation in your own outreach?", -14),
        (True, "I teach people to avoid automation actually. Prefer genuine connections.", -13),
        (False, "That's fair - we're on the same page about quality. Our tool is built for that, not spray and pray.", -12),
        (True, "Appreciate it but I'm really not interested. Best of luck.", -11),
    ],
    18: [  # Ryan (wrong fit / failed)
        (False, "Head of sales at an AI startup - how are you building your outbound motion from scratch?", -9),
        (True, "Figuring it out honestly. We're pre-product-market fit so still experimenting.", -8),
        (False, "Makes sense. What channels are you testing?", -7),
        (True, "Email mostly. LinkedIn feels too slow for our stage.", -6),
        (False, "Totally valid. We might be better suited once you have a repeatable motion. Happy to reconnect then.", -5),
        (True, "Yeah let's do that. Not the right time.", -4),
    ],
}
