...
class TrackedLink(models.Model):
    ...
    original_url: models.URLField = models.URLField(
        max_length=1000, help_text="Original destination URL"
    )
    ...
    utm_source: models.CharField = models.CharField(
        max_length=100, blank=True, help_text="UTM source parameter"
    )
    utm_medium: models.CharField = models.CharField(
        max_length=100, blank=True, help_text="UTM medium parameter"
    )
    utm_campaign: models.CharField = models.CharField(
        max_length=100, blank=True, help_text="UTM campaign parameter"
    )
    utm_term: models.CharField = models.CharField(
        max_length=100, blank=True, help_text="UTM term parameter"
    )
    utm_content: models.CharField = models.CharField(
        max_length=100, blank=True, help_text="UTM content parameter"
    )
    ...
    # Tracking details
    last_ip: models.GenericIPAddressField | None = models.GenericIPAddressField(
