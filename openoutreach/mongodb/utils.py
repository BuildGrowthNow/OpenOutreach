...
class AggregationPipelines:
    ...
    def get_lead_analytics_pipeline(
        campaign_id: str, state_filter: Optional[str] = None
    ) -> List[Dict[str, Any]]:
        """
    ...
    def create_backup(
        ...
        try:
            ...
            if self.backup_collection is not None:
                ...
                logger.info(
                    f"Backup created for '{collection_name}': {result.inserted_id}"
                )
                return {
    ...
    def cleanup_orphaned_data(self, collection_name: str, reference_field: str) -> int:
        ...
        try:
            ...
            if orphaned_ids:
                ...
                logger.info(
                    f"Cleaned up {result.deleted_count} orphaned records from '{collection_name}'"
                )
                return result.deleted_count
...
def validate_document(
    collection_name: str, document: Dict[str, Any], schema: Dict[str, Any]
) -> bool:
    """
