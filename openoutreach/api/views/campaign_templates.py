...
from openoutreach.api.serializers.campaigns import CampaignTemplateSerializer, CampaignTemplateCreateSerializer
...
class CampaignTemplateCloneView(APIView):
    ...
    def post(self, request, pk):
        ...
        return Response({
            ...
            'updated_at': cloned_template.updated_at.isoformat() if cloned_template.updated_at else None,
        }, status=status.HTTP_201_CREATED)
