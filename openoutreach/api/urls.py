...
urlpatterns = [
    ...
    path(
        ...
        LinkSupabaseUserView.as_view(),
        name="link-supabase-user",
    ),
    path(
        "auth/supabase-user/<str:supabase_user_id>/",
        SupabaseUserInfoView.as_view(),
        name="supabase-user-info",
    ),
    path(
        "auth/verify-supabase-token/",
        SupabaseVerifyTokenView.as_view(),
    ...
    path(
        "campaigns/<int:pk>/leads/", CampaignLeadsView.as_view(), name="campaign-leads"
    ),
    path(
        "campaigns/<int:pk>/leads/upload/",
        CampaignLeadsUploadView.as_view(),
        name="campaign-leads-upload",
    ),
    path(
        "campaigns/<int:pk>/messages/",
        CampaignMessagesView.as_view(),
        name="campaign-messages",
    ),
    path(
        "campaigns/<int:pk>/analytics/",
        CampaignAnalyticsView.as_view(),
        name="campaign-analytics",
    ),
    path(
        "campaigns/<int:pk>/state-machine/",
        CampaignStateMachineView.as_view(),
        name="campaign-state-machine",
    ),
    path(
        "campaigns/<int:pk>/state-machine/validate/",
        CampaignStateMachineView.as_view(),
        name="campaign-state-machine-validate",
    ),
    path(
    ...
    path(
        ...
        CampaignStatusView.as_view(),
        name="campaign-status",
    ),
    # Ghost mode endpoints - separate endpoints for different actions
    path(
        "campaigns/<int:pk>/ghost-mode/simulations/",
        CampaignGhostModeSimulationListView.as_view(),
        name="campaign-ghost-mode-simulations",
    ),
    path(
        "campaigns/<int:pk>/ghost-mode/action/",
        CampaignGhostModeActionView.as_view(),
        name="campaign-ghost-mode-action",
    ),
    # Campaign templates endpoints
    path(
        "campaign-templates/",
        CampaignTemplateListView.as_view(),
        name="campaign-template-list",
    ),
    path(
        "campaign-templates/<int:pk>/",
        CampaignTemplateDetailView.as_view(),
        name="campaign-template-detail",
    ),
    path(
        "campaign-templates/<int:pk>/clone/",
        CampaignTemplateCloneView.as_view(),
        name="campaign-template-clone",
    ),
    path(
        "campaign-templates/<int:pk>/create-campaign/",
        CampaignCreateFromTemplateView.as_view(),
    ...
    path(
        "leads/<int:pk>/notes/<int:note_id>/",
        LeadNotesView.as_view(),
        name="lead-notes-detail",
    ),
    path(
    ...
    path(
        "links/<int:pk>/analytics/", LinkAnalyticsView.as_view(), name="link-analytics"
    ),
    ...
    path(
        ...
        StateMachineSimulationView.as_view(),
        name="state-machine-simulate",
    ),
    # State machine endpoints (global execution)
    path(
        "state-machine/execute/",
        StateMachineExecutionView.as_view(),
        name="state-machine-execute",
    ),
    # LinkedIn credentials endpoints
    path(
        "linkedin-credentials/",
        LinkedInCredentialsView.as_view(),
        name="linkedin-credentials-list",
    ),
    path(
        "linkedin-credentials/<int:pk>/",
        LinkedInCredentialsView.as_view(),
        name="linkedin-credentials-detail",
    ),
    path(
    ...
    path(
        ...
        LinkedInCredentialsRotationView.as_view(),
        name="linkedin-credentials-rotate",
    ),
    path(
        "linkedin-credentials/<int:pk>/health/",
        LinkedInCredentialsHealthView.as_view(),
        name="linkedin-credentials-health",
    ),
    path(
        "linkedin-credentials/<int:pk>/logs/",
        LinkedInCredentialsLogsView.as_view(),
        name="linkedin-credentials-logs",
    ),
    ...
    path(
        ...
        LinkedInProfileHealthView.as_view(),
        name="linkedin-profile-health",
    ),
    # LinkedIn setup endpoints (OAuth/cookie guide)
    path(
        "linkedin-setup/cookie-instructions/",
        LinkedInCookieInstructionsView.as_view(),
        name="linkedin-setup-cookie-instructions",
    ),
    path(
        "linkedin-setup/guide/",
        LinkedInSetupGuideView.as_view(),
        name="linkedin-setup-guide",
    ),
    path(
        "linkedin-setup/status/",
        LinkedInSetupStatusView.as_view(),
        name="linkedin-setup-status",
    ),
]
...
urlpatterns += [
    ...
    re_path(
        r"^settings/rate-limits$", RateLimitsView.as_view(), name="rate-limits-no-slash"
    ),
    re_path(
        r"^settings/daily-usage$", DailyUsageView.as_view(), name="daily-usage-no-slash"
    ),
    # Campaigns endpoints (no trailing slash)
    re_path(r"^campaigns$", CampaignListView.as_view(), name="campaign-list-no-slash"),
    re_path(
        r"^campaigns/(?P<pk>[0-9]+)$",
        CampaignDetailView.as_view(),
        name="campaign-detail-no-slash",
    ),
    re_path(
        r"^campaigns/(?P<pk>[0-9]+)/leads$",
        CampaignLeadsView.as_view(),
        name="campaign-leads-no-slash",
    ),
    re_path(
        r"^campaigns/(?P<pk>[0-9]+)/leads/upload$",
        CampaignLeadsUploadView.as_view(),
        name="campaign-leads-upload-no-slash",
    ),
    re_path(
        r"^campaigns/(?P<pk>[0-9]+)/messages$",
        CampaignMessagesView.as_view(),
        name="campaign-messages-no-slash",
    ),
    re_path(
        r"^campaigns/(?P<pk>[0-9]+)/analytics$",
        CampaignAnalyticsView.as_view(),
        name="campaign-analytics-no-slash",
    ),
    re_path(
        r"^campaigns/(?P<pk>[0-9]+)/state-machine$",
        CampaignStateMachineView.as_view(),
        name="campaign-state-machine-no-slash",
    ),
    re_path(
        r"^campaigns/(?P<pk>[0-9]+)/state-machine/validate$",
        CampaignStateMachineView.as_view(),
        name="campaign-state-machine-validate-no-slash",
    ),
    re_path(
    ...
    re_path(
        ...
        CampaignStatusView.as_view(),
        name="campaign-status-no-slash",
    ),
    re_path(
        r"^campaigns/(?P<pk>[0-9]+)/ghost-mode/simulations$",
        CampaignGhostModeSimulationListView.as_view(),
        name="campaign-ghost-mode-simulations-no-slash",
    ),
    re_path(
        r"^campaigns/(?P<pk>[0-9]+)/ghost-mode/action$",
        CampaignGhostModeActionView.as_view(),
        name="campaign-ghost-mode-action-no-slash",
    ),
    # Campaign templates endpoints (no trailing slash)
    re_path(
        r"^campaign-templates$",
        CampaignTemplateListView.as_view(),
        name="campaign-template-list-no-slash",
    ),
    re_path(
        r"^campaign-templates/(?P<pk>[0-9]+)$",
        CampaignTemplateDetailView.as_view(),
        name="campaign-template-detail-no-slash",
    ),
    re_path(
        r"^campaign-templates/(?P<pk>[0-9]+)/clone$",
        CampaignTemplateCloneView.as_view(),
        name="campaign-template-clone-no-slash",
    ),
    re_path(
        r"^campaign-templates/(?P<pk>[0-9]+)/create-campaign$",
        CampaignCreateFromTemplateView.as_view(),
        name="campaign-template-create-campaign-no-slash",
    ),
    # Leads endpoints (no trailing slash)
    re_path(r"^leads$", LeadListView.as_view(), name="lead-list-no-slash"),
    re_path(
        r"^leads/(?P<pk>[0-9]+)$", LeadDetailView.as_view(), name="lead-detail-no-slash"
    ),
    re_path(
        r"^leads/(?P<pk>[0-9]+)/profile$",
        LeadProfileView.as_view(),
        name="lead-profile-no-slash",
    ),
    re_path(
        r"^leads/(?P<pk>[0-9]+)/messages$",
        LeadMessagesView.as_view(),
        name="lead-messages-no-slash",
    ),
    re_path(
        r"^leads/(?P<pk>[0-9]+)/notes$",
        LeadNotesView.as_view(),
        name="lead-notes-list-no-slash",
    ),
    re_path(
        r"^leads/(?P<pk>[0-9]+)/notes/(?P<note_id>[0-9]+)$",
        LeadNotesView.as_view(),
        name="lead-notes-detail-no-slash",
    ),
    re_path(
    ...
    re_path(
        r"^links/(?P<pk>[0-9]+)$",
        LinksDetailView.as_view(),
        name="link-detail-no-slash",
    ),
    re_path(
        r"^links/(?P<pk>[0-9]+)/analytics$",
        LinkAnalyticsView.as_view(),
        name="link-analytics-no-slash",
    ),
    # Link redirect is handled by CRM (must be before api to avoid prefix)
    # State machine endpoints (no trailing slash)
    re_path(
        r"^state-machine/simulate$",
        StateMachineSimulationView.as_view(),
        name="state-machine-simulate-no-slash",
    ),
    # State machine endpoints (no trailing slash) - execution
    re_path(
        r"^state-machine/execute$",
        StateMachineExecutionView.as_view(),
        name="state-machine-execute-no-slash",
    ),
    # LinkedIn credentials endpoints (no trailing slash)
    re_path(
        r"^linkedin-credentials$",
        LinkedInCredentialsView.as_view(),
        name="linkedin-credentials-list-no-slash",
    ),
    re_path(
        r"^linkedin-credentials/(?P<pk>[0-9]+)$",
        LinkedInCredentialsView.as_view(),
        name="linkedin-credentials-detail-no-slash",
    ),
    re_path(
    ...
    re_path(
        ...
        LinkedInCredentialsRotationView.as_view(),
        name="linkedin-credentials-rotate-no-slash",
    ),
    re_path(
        r"^linkedin-credentials/(?P<pk>[0-9]+)/health$",
        LinkedInCredentialsHealthView.as_view(),
        name="linkedin-credentials-health-no-slash",
    ),
    re_path(
        r"^linkedin-credentials/(?P<pk>[0-9]+)/logs$",
        LinkedInCredentialsLogsView.as_view(),
        name="linkedin-credentials-logs-no-slash",
    ),
    ...
    re_path(
        ...
        LinkedInProfileHealthView.as_view(),
        name="linkedin-profile-health-no-slash",
    ),
    # LinkedIn setup endpoints (no trailing slash)
    re_path(
        r"^linkedin-setup/cookie-instructions$",
        LinkedInCookieInstructionsView.as_view(),
        name="linkedin-setup-cookie-instructions-no-slash",
    ),
    re_path(
        r"^linkedin-setup/guide$",
        LinkedInSetupGuideView.as_view(),
        name="linkedin-setup-guide-no-slash",
    ),
    re_path(
        r"^linkedin-setup/status$",
        LinkedInSetupStatusView.as_view(),
        name="linkedin-setup-status-no-slash",
    ),
]
