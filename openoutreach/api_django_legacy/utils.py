...
class APIResponseBuilder:
    ...
    def set_pagination(self, page: int, limit: int, total: int) -> "APIResponseBuilder":
        ...
        self._pagination = PaginationInfo(page=page, limit=limit, total=total)
        return self
...
def create_message_response(
    success: bool, message: str, data: Optional[Any] = None
) -> Dict[str, Any]:
    """
...
def create_single_response(
    item: Any, success: bool = True, message: Optional[str] = None
) -> Dict[str, Any]:
    """
