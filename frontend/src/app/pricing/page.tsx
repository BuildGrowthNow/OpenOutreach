...
const comparisonFeatures: ComparisonFeature[] = [
  ...
  { name: 'Sales Navigator', starter: false, pro: true, business: true, agency: true, cloud: true },
  { name: 'API Access', starter: false, pro: true, business: true, agency: true, cloud: true },
