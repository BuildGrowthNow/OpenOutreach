      ...
      <Card className="bg-muted/50">
        ...
        <CardContent className="space-y-4">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              Your plan will change at the end of your current billing period. If you have more LinkedIn or WhatsApp accounts than your new plan allows, the oldest accounts are automatically deactivated to fit the new limits.
            </p>
          </div>
          <div>
